...
\begin{rSection}{Education}
	...
	\begin{rSubsection}{The University of Edinburgh}{Sept, 2022 - present}{PhD Student, IMNS}{Edinburgh, Scotland}
		...
		\item Research theme: Cognitive processing system design based on memristor associative memory. 
	\end{rSubsection}
...
\begin{rSection}{Interests}
	...
	\item Very interested yet rather ignorant in classical music, operas and cocktails. 
\end{rSection}
