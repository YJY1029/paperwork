...
\begin{rSection}{Research Experience}
	...
	\begin{rSubsection}{ASOCA2}{Nov, 2022 - Dec, 2023}{The University of Edinburgh}{PhD Sub-project}
		\item Design and verification of digital peripheral modules
...
\begin{rSection}{Current Projects}
	...
	\begin{rSubsection}{ASOCA3-FPGA}{Jan, 2024 - present}{The University of Edinburgh}{PhD Sub-project}
		\item Designing associative memory and random-access memory in FPGA
		\item Development of a graph database accelerator architecture
	\end{rSubsection}
	
	% \begin{rSubsection}{Pyramid detector}{Feb, 2024 - present}{The University of Edinburgh}{PhD Sub-project}
	% 	\item Development of automatic fault detection on wafer with pattern recognition
	% \end{rSubsection}
